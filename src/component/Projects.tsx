  ...
  const projects: Project[] = [
    {
      ...
      impact: "Improves recruiter retention by presenting experience in a familiar and highly engaging workspace theme.",
      image: "/portfolio.png",
    ...
    },
    {
      ...
      impact: "Boosted client's weekly online tourist inquiries by introducing automated booking paths.",
      image: "/rafts.png",
    ...
    },
    {
      ...
      impact: "Engaged technical visitors with rich visual animations, illustrating high proficiency in creative engineering.",
      image: "/3d.png",
    ...
    },
    {
      ...
      impact: "Demonstrated strong foundational knowledge of HTML5 structure, CSS layout patterns, and clean DOM script handling.",
      image: "/amazon.png",
    ...
    },
    {
      ...
      impact: "Empowers B.Tech students and job seekers to instantly align their resumes with modern applicant tracking standards.",
      image:
            ...
            >
              <div className="relative z-20">
                ...
                <p className="jetbrains-mono text-gray-400 text-sm md:text-base mt-2 font-medium">
                  <span className="text-[#60A5FA] font-mono">Stack:</span> {proj.tech}
                </p>
                ...
                <div className="mt-3 flex flex-col gap-1 max-w-xl text-[11px] md:text-xs text-gray-500 font-mono">
                  <span className="text-gray-400 font-semibold uppercase tracking-wider">Key Features:</span>
                ...
                <p className="jetbrains-mono text-emerald-400/90 text-xs mt-3 max-w-xl italic">
                  📈 <span className="font-semibold uppercase tracking-wider text-[11px]">Impact:</span> {proj.impact}
                </p>
